...
project = "OpenFF Recharge"
copyright = (
    "2022, Open Force Field Consortium. Project structure based on the "
...
autosummary_context = {
    ...
    "exclude_modules": [
        "openff.recharge.aromaticity",
        "openff.recharge.cli",
        "openff.recharge.data",
        "openff.recharge.tests",
    ]
}
...
html_theme_options = {
    ...
    "repo_url": "https://github.com/openforcefield/openff-recharge",
    # The name of the repo. If must be set if repo_url is set
    "repo_name": "openff-recharge",
...
latex_documents = [
    (master_doc, "recharge.tex", "OpenFF Recharge Documentation", "recharge", "manual"),
]
...
man_pages = [(master_doc, "recharge", "OpenFF Recharge Documentation", [author], 1)]
